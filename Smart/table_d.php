                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            修改设备数据
                            <?php
                            $rs = mysql_query("SELECT * FROM device WHERE getType = '$getType'AND D_fid = $fid AND getId = '$getId' ");
                            //输出
                            while($row=mysql_fetch_object($rs)){
                                echo "<font color='#daa520'>设备名称:".$row->Dname."；设备号:".$row->getType."-".$row->getId."；数据:".$row->Ddata."；所属家庭:".$row->D_fid."</font>";
                            }
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <div class="form-group">
                                    <form role="form" action="mod_d.php" method="post">
                                        <div class="form-group">
                                            <label>请输入新数据(全部留空既删除)</label>
                                            <p><input name="name" class="form-control" placeholder="$row->Dname" ></p>
                                            <p><input name="fid" class="form-control" placeholder="所属家庭ID"></p>
                                            <p><input name="data" class="form-control" placeholder="数据（谨慎修改）"></p>

                                            <input type="hidden" name="getData" value=<?php echo $getId."-".$getType."-".$fid?>>
