...
<div class="login_div">
	...
	<form action="login_chek.php" class="login" method="post">
		<div class="nav">
			<div class="nav login_nav">
				...
				<div class="col-xs-6 login_usernameInput">
					<input type="text" name="adminName" id="name" value="" placeholder="&nbsp;&nbsp;管理员账号"  onblur="javascript:ok_or_errorBylogin(this)" />
				</div>
			...
			<div class="nav login_psdNav">
				...
				<div class="col-xs-6">
					<input type="password" name="adminPsd" id="psd" value="" placeholder="&nbsp;&nbsp;密码" onBlur="javascript:ok_or_errorBylogin(this)" />
				</div>
				<div class="col-xs-1 ok_gou">
					√
				</div>
