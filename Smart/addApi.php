                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            添加/修改接口信息  <?php
                            $rs = mysql_query("SELECT * FROM api WHERE id = $id");
                            //输出
                            while($row=mysql_fetch_object($rs)){
                                echo "<font color='#daa520'>接口ID:".$row->id."；文件名:".$row->file."</font>";
                            }
                                ...
                                <div class="form-group">
                                    <form role="form" action="api.php" method="post">
                                        <div class="form-group">
                                            ...
                                            <p><input name="file" class="form-control" placeholder="文件名称"></p>
                                            <p><input name="url" class="form-control" placeholder="获取数据示例(短链接)"></p>
                                            <p><input name="status" class="form-control" placeholder="状态值信息"></p>
                                            <p><input name="etc" class="form-control" placeholder="功能说明"></p>
