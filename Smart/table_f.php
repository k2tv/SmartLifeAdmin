                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            修改家庭数据  <?php
                            $rs = mysql_query("SELECT * FROM family WHERE Fid = $id");
                            //输出
                            while($row=mysql_fetch_object($rs)){
                                echo "<font color='#daa520'>家庭ID:".$row->Fid."；名称:".$row->Fname."；终端ID:".$row->TerminalId."；创建者ID:".$row->CreatorId."</font>";
                            }
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <div class="form-group">
                                    <form role="form" action="mod_f.php" method="post">
                                        <div class="form-group">
                                            <label>请输入新数据(全部留空既删除)</label>
                                            <p><input name="name" class="form-control" placeholder="家庭名称"></p>
                                            <p><input name="tid" class="form-control" placeholder="终端设备ID"></p>
                                            <p><input name="cid" class="form-control" placeholder="创建者ID"></p>
